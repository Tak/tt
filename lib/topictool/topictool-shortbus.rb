...
module TopicTool
  class TopicToolShortBus < ShortBus::ShortBus
...
EOT
      ...
      hook_command('TT', ShortBus::XCHAT_PRI_NORM, method( :tt_handler), @help_text)
      hook_server('PRIVMSG', ShortBus::XCHAT_PRI_NORM, method(:buffer_message))
      hook_print('Your Message', ShortBus::XCHAT_PRI_NORM, method(:your_message))
